...
@section('title', 'Supplier Billing Details')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">{{ $supplier->supplier_name }} - Billing Details</h4>
                    <div>
                        <a href="{{ route('suppliers.billing.create', $supplier->id) }}" class="btn btn-success">
                            <i class="bi bi-plus"></i> Add Bill
                        </a>
                        <a href="{{ route('suppliers.billing.index') }}" class="btn btn-secondary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('suppliers.billing.edit', [$supplier->id, $bill->id]) }}" 
                                                ...
                                                @endif
                                                <form action="{{ route('suppliers.billing.destroy', [$supplier->id, $bill->id]) }}" 
                                    ...
                                    <div class="modal fade" id="paymentModal{{ $bill->id }}" tabindex="-1" role="dialog">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('suppliers.billing.payment', [$supplier->id, $bill->id]) }}" method="POST">
                                                    @csrf
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">No bills found for this supplier</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
